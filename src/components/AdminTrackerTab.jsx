  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-4">
        ...
        {/* ✅ Filter buttons — one click para makita agad ang "Not Submitted" */}
                ...
                {key === "all"
                  ...
                  : key === "submitted"
                    ...
                    : key === "not_submitted"
                      ...
                      : key === "approved"
                        ? approvedCount
                        : trackerData.filter((d) => d.submitted && !d.approved)
                            .length}
              </span>
            </button>
          ))}
      ...
      {filtered.length === 0 ? (
        ...
        <>
          ...
          <div className="flex flex-col gap-3 sm:hidden">
            {paginated.map(({ worker: w, report: r, submitted, approved }) => (
              <div
                key={w._id}
          ...
          {/* ✅ Same Pagination component as Reports, Users, Logs */}
          <Pagination
            currentPage={page}
